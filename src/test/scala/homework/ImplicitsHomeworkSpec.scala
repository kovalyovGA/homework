...
import homework.ImplicitsHomework.SuperVipCollections4s._
import homework.ImplicitsHomeworkSpec.TestValue
...
class ImplicitsHomeworkSpec extends AnyFreeSpec with Matchers {
  ...
  "Iterate2 instances provided" - {
    "for Map" in {
      assertCompiles(
        """import homework.ImplicitsHomework.SuperVipCollections4s._
          |import homework.ImplicitsHomework.SuperVipCollections4s.instances._
          |
  ...
  "TwitCache" - {
    import homework.ImplicitsHomework.MyTwitter._
    val id1 = 1L //8
    val twit1 = Twit( //12
      id = id1, //8
      userId = 1, //4
